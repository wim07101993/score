...
type IndexerClient interface {
	IndexScores(ctx context.Context, in *IndexScoresRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *indexerClient) IndexScores(ctx context.Context, in *IndexScoresRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type IndexerServer interface {
	IndexScores(context.Context, *IndexScoresRequest) (*empty.Empty, error)
...
func (UnimplementedIndexerServer) IndexScores(context.Context, *IndexScoresRequest) (*empty.Empty, error) {
