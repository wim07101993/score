...
abstract class IDashedFormatting {
...
abstract class IOptionalUniqueId {
  String get id;
}
...
abstract class IPrintStyle implements IPosition, IFont, IColor {
}

/// The print-style-align attribute group adds the halign and valign attributes to the position, font, and color attributes.
abstract class IPrintStyleAlign implements IPrintStyle, IHalign, IValign {
}
...
abstract class IPrintout implements IPrintObject, IPrintSpacing {
  YesNo get printDot;
...
abstract class ISystemRelation {
...
abstract class ISymbolFormatting implements IJustify, IPrintStyleAlign, ITextDecoration, ITextRotation, ILetterSpacing, ILineHeight, ITextDirection, IEnclosure {
}
...
abstract class ITextDecoration {
...
abstract class ITextFormatting implements IJustify, IPrintStyleAlign, ITextDecoration, ITextRotation, ILetterSpacing, ILineHeight, ITextDirection, IEnclosure {
  String get lang;
  String get space;
}
...
abstract class IImageAttributes implements IPosition, IHalign, IValignImage {
  String get source;
  String get type;
  Tenths get height;
  Tenths get width;
...
abstract class IPrintAttributes {
...
abstract class IElementPosition {
  String get element;
  int get position;
}
...
abstract class ILinkAttributes {
  String get href;
  String get type;
  String get role;
  String get title;
...
abstract class IGroupNameText implements IPrintStyle, IJustify {
}
...
abstract class IMeasureAttributes implements IOptionalUniqueId {
  String get number;
...
abstract class IPartAttributes {
  String get id;
}
...
abstract class IEditorialVoiceDirection {
}
...
abstract class IVirtualInstrumentData {
}
...
abstract class INonTraditionalKey {
}
...
abstract class ILeftRightMargins {
}
...
abstract class IDisplayStepOctave {
}
