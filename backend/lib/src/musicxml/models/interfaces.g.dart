...
/// 	first-beat = "25"
/// 	last-beat = "75"
abstract class BendSoundProperties {
...
abstract class BezierProperties {
  Tenths? get bezierX;
  Tenths? get bezierY;
  Tenths? get bezierX2;
  Tenths? get bezierY2;
...
abstract class ColorProperties {
  Color? get color;
}
...
abstract class DashedFormattingProperties {
...
abstract class DirectiveProperties {
  YesNo? get directive;
}
...
abstract class HalignProperties {
...
abstract class JustifyProperties {
...
abstract class LetterSpacingProperties {
...
abstract class LevelDisplayProperties {
...
abstract class LineHeightProperties {
...
abstract class OptionalUniqueIdProperties {
  String? get id;
}
...
abstract class OrientationProperties {
...
abstract class PositionProperties {
  Tenths? get defaultX;
  Tenths? get defaultY;
...
abstract class PrintObjectProperties {
...
abstract class PrintSpacingProperties {
...
abstract class PrintStyleProperties implements PositionProperties, FontProperties, ColorProperties {
}
...
abstract class PrintoutProperties implements PrintObjectProperties, PrintSpacingProperties {
  YesNo? get printDot;
...
abstract class SmuflProperties {
...
abstract class SystemRelationProperties {
...
abstract class TextDecorationProperties {
...
abstract class TextDirectionProperties {
...
abstract class TextRotationProperties {
...
abstract class TrillSoundProperties {
...
abstract class ValignProperties {
  Valign? get valign;
}
...
abstract class ValignImageProperties {
...
abstract class XPositionProperties {
  Tenths? get defaultX;
  Tenths? get defaultY;
  Tenths? get relativeX;
  Tenths? get relativeY;
...
abstract class YPositionProperties {
  Tenths? get defaultX;
  Tenths? get defaultY;
  Tenths? get relativeX;
  Tenths? get relativeY;
...
abstract class ImageAttributesProperties implements PositionProperties, HalignProperties, ValignImageProperties {
  String get source;
  String get type;
  Tenths? get height;
  Tenths? get width;
...
abstract class PrintAttributesProperties {
...
abstract class ElementPositionProperties {
  String? get element;
  int? get position;
}
...
abstract class LinkAttributesProperties {
  String get href;
  String? get type;
  String? get role;
  String? get title;
...
abstract class GroupNameTextProperties implements PrintStyleProperties, JustifyProperties {
}
...
abstract class MeasureAttributesProperties implements OptionalUniqueIdProperties {
  String get number;
...
abstract class PartAttributesProperties {
  String get id;
}
...
abstract class EditorialVoiceDirectionProperties {
}
...
abstract class FootnoteProperties {
}
...
abstract class VirtualInstrumentDataProperties {
}
...
abstract class NonTraditionalKeyProperties {
}
...
abstract class DisplayStepOctaveProperties {
}
...
abstract class FullNoteProperties {
}
...
abstract class SymbolFormattingProperties implements JustifyProperties, PrintStyleAlignProperties, TextDecorationProperties, TextRotationProperties, LetterSpacingProperties, LineHeightProperties, TextDirectionProperties, EnclosureProperties {
}
...
abstract class TextFormattingProperties implements JustifyProperties, PrintStyleAlignProperties, TextDecorationProperties, TextRotationProperties, LetterSpacingProperties, LineHeightProperties, TextDirectionProperties, EnclosureProperties {
  String? get lang;
  String? get space;
}
