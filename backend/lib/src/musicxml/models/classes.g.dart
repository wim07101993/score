...
class AccidentalText implements TextFormattingGroup {
...
class Coda implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const Coda({
    required this.smufl,
    required this.defaultX,
    required this.defaultY,
...
class Dynamics implements PrintStyleAlignGroup, PlacementGroup, TextDecorationGroup, EnclosureGroup, OptionalUniqueIdGroup {
 const Dynamics({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class EmptyPlacement implements PrintStyleGroup, PlacementGroup {
...
class EmptyPlacementSmufl implements PrintStyleGroup, PlacementGroup, SmuflGroup {
...
class EmptyPrintStyle implements PrintStyleGroup {
...
class EmptyPrintStyleAlign implements PrintStyleAlignGroup {
...
class EmptyPrintStyleAlignId implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
...
class EmptyPrintObjectStyleAlign implements PrintObjectGroup, PrintStyleAlignGroup {
...
class EmptyTrillSound implements PrintStyleGroup, PlacementGroup, TrillSoundGroup {
...
class HorizontalTurn implements PrintStyleGroup, PlacementGroup, TrillSoundGroup {
...
class Fermata implements PrintStyleGroup, OptionalUniqueIdGroup {
 const Fermata({
    required this.value,
    required this.type,
    required this.defaultX,
...
class Fingering implements PrintStyleGroup, PlacementGroup {
 const Fingering({
    required this.value,
...
class FormattedSymbol implements SymbolFormattingGroup {
...
class FormattedSymbolId implements SymbolFormattingGroup, OptionalUniqueIdGroup {
...
class FormattedText implements TextFormattingGroup {
 const FormattedText({
    required this.value,
    required this.lang,
    required this.space,
...
class FormattedTextId implements TextFormattingGroup, OptionalUniqueIdGroup {
...
class Fret implements FontGroup, ColorGroup {
 const Fret({
    required this.value,
    required this.fontFamily,
    required this.fontStyle,
...
class Level implements LevelDisplayGroup {
 const Level({
    required this.value,
...
class NameDisplay implements PrintObjectGroup {
 const NameDisplay({
    required this.printObject,
  });
...
class Segno implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const Segno({
    required this.smufl,
    required this.defaultX,
    required this.defaultY,
...
class GuitarString implements PrintStyleGroup, PlacementGroup {
 const GuitarString({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class WavyLine implements PositionGroup, PlacementGroup, ColorGroup, TrillSoundGroup {
 const WavyLine({
    required this.type,
...
class Clef implements PrintStyleGroup, PrintObjectGroup, OptionalUniqueIdGroup {
 const Clef({
    required this.number,
...
class ForPart implements OptionalUniqueIdGroup {
 const ForPart({
    required this.number,
    required this.id,
  });
...
class Key implements PrintStyleGroup, PrintObjectGroup, OptionalUniqueIdGroup {
 const Key({
    required this.number,
    required this.defaultX,
    required this.defaultY,
...
class LineDetail implements ColorGroup, LineTypeGroup, PrintObjectGroup {
 const LineDetail({
    required this.line,
    required this.width,
    required this.color,
...
class MeasureStyle implements FontGroup, ColorGroup, OptionalUniqueIdGroup {
 const MeasureStyle({
    required this.number,
    required this.fontFamily,
    required this.fontStyle,
...
class PartSymbol implements PositionGroup, ColorGroup {
 const PartSymbol({
    required this.value,
...
class StaffDetails implements PrintObjectGroup, PrintSpacingGroup {
 const StaffDetails({
    required this.number,
...
class Time implements PrintStyleAlignGroup, PrintObjectGroup, OptionalUniqueIdGroup {
 const Time({
    required this.number,
    required this.symbol,
    required this.separator,
...
class Transpose implements OptionalUniqueIdGroup {
 const Transpose({
    required this.number,
    required this.id,
  });
...
class BarStyleColor implements ColorGroup {
 const BarStyleColor({
    required this.value,
    required this.color,
  });
...
class Barline implements OptionalUniqueIdGroup {
 const Barline({
    required this.location,
    required this.segno,
    required this.coda,
...
class Ending implements PrintObjectGroup, PrintStyleGroup, SystemRelationGroup {
 const Ending({
    required this.value,
    required this.number,
    required this.type,
...
class AccordionRegistration implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
...
class Barre implements ColorGroup {
 const Barre({
    required this.type,
    required this.color,
  });
...
class HarmonyAlter implements PrintObjectGroup, PrintStyleGroup {
 const HarmonyAlter({
    required this.value,
    required this.location,
    required this.printObject,
...
class BassStep implements PrintStyleGroup {
 const BassStep({
    required this.value,
    required this.text,
    required this.defaultX,
...
class Bracket implements LineTypeGroup, DashedFormattingGroup, PositionGroup, ColorGroup, OptionalUniqueIdGroup {
 const Bracket({
    required this.type,
    required this.number,
...
class Dashes implements DashedFormattingGroup, PositionGroup, ColorGroup, OptionalUniqueIdGroup {
 const Dashes({
    required this.type,
    required this.number,
    required this.dashLength,
...
class Degree implements PrintObjectGroup {
 const Degree({
    required this.printObject,
  });
...
class DegreeAlter implements PrintStyleGroup {
 const DegreeAlter({
    required this.value,
...
class DegreeType implements PrintStyleGroup {
 const DegreeType({
    required this.value,
    required this.text,
    required this.defaultX,
...
class DegreeValue implements PrintStyleGroup {
 const DegreeValue({
    required this.value,
    required this.symbol,
    required this.text,
...
class Direction implements PlacementGroup, DirectiveGroup, SystemRelationGroup, OptionalUniqueIdGroup {
 const Direction({
    required this.placement,
...
class DirectionType implements OptionalUniqueIdGroup {
 const DirectionType({
    required this.id,
  });
...
class Frame implements PositionGroup, ColorGroup, HalignGroup, ValignImageGroup, OptionalUniqueIdGroup {
 const Frame({
...
class Grouping implements OptionalUniqueIdGroup {
 const Grouping({
    required this.type,
    required this.number,
...
class Harmony implements PrintObjectGroup, PrintStyleGroup, PlacementGroup, SystemRelationGroup, OptionalUniqueIdGroup {
 const Harmony({
    required this.type,
...
class HarpPedals implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const HarpPedals({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class Image implements ImageAttributesGroup, OptionalUniqueIdGroup {
 const Image({
...
class Inversion implements PrintStyleGroup {
 const Inversion({
    required this.value,
    required this.text,
    required this.defaultX,
...
class Kind implements PrintStyleGroup, HalignGroup, ValignGroup {
 const Kind({
    required this.value,
    required this.useSymbols,
    required this.text,
...
class MeasureNumbering implements PrintStyleAlignGroup {
...
class Metronome implements PrintStyleAlignGroup, PrintObjectGroup, JustifyGroup, OptionalUniqueIdGroup {
 const Metronome({
    required this.parentheses,
    required this.defaultX,
    required this.defaultY,
...
class NumeralKey implements PrintObjectGroup {
 const NumeralKey({
    required this.printObject,
  });
...
class NumeralRoot implements PrintStyleGroup {
 const NumeralRoot({
    required this.value,
    required this.text,
    required this.defaultX,
...
class OctaveShift implements DashedFormattingGroup, PrintStyleGroup, OptionalUniqueIdGroup {
 const OctaveShift({
    required this.type,
    required this.number,
    required this.size,
...
class OtherDirection implements PrintObjectGroup, PrintStyleAlignGroup, SmuflGroup, OptionalUniqueIdGroup {
...
class Pedal implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const Pedal({
    required this.type,
    required this.number,
    required this.line,
...
class PerMinute implements FontGroup {
 const PerMinute({
    required this.value,
    required this.fontFamily,
    required this.fontStyle,
...
class Percussion implements PrintStyleAlignGroup, EnclosureGroup, OptionalUniqueIdGroup {
 const Percussion({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class PrincipalVoice implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
...
class Print implements PrintAttributesGroup, OptionalUniqueIdGroup {
 const Print({
...
class RootStep implements PrintStyleGroup {
 const RootStep({
    required this.value,
    required this.text,
    required this.defaultX,
...
class Scordatura implements OptionalUniqueIdGroup {
 const Scordatura({
    required this.id,
  });
...
class Sound implements OptionalUniqueIdGroup {
 const Sound({
    required this.tempo,
...
class StaffDivide implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const StaffDivide({
    required this.type,
    required this.defaultX,
    required this.defaultY,
...
class StringMute implements PrintStyleAlignGroup, OptionalUniqueIdGroup {
 const StringMute({
    required this.type,
    required this.defaultX,
    required this.defaultY,
...
class Wedge implements LineTypeGroup, DashedFormattingGroup, PositionGroup, ColorGroup, OptionalUniqueIdGroup {
 const Wedge({
    required this.type,
    required this.number,
...
class Bookmark implements ElementPositionGroup {
 const Bookmark({
    required this.id,
    required this.name,
    required this.element,
...
class Link implements LinkAttributesGroup, ElementPositionGroup, PositionGroup {
 const Link({
    required this.name,
    required this.href,
    required this.type,
...
class Accidental implements LevelDisplayGroup, PrintStyleGroup {
 const Accidental({
    required this.value,
...
class AccidentalMark implements LevelDisplayGroup, PrintStyleGroup, PlacementGroup, OptionalUniqueIdGroup {
...
class Arpeggiate implements PositionGroup, PlacementGroup, ColorGroup, OptionalUniqueIdGroup {
 const Arpeggiate({
    required this.number,
    required this.direction,
...
class Articulations implements OptionalUniqueIdGroup {
 const Articulations({
    required this.id,
  });
...
class Arrow implements PrintStyleGroup, PlacementGroup, SmuflGroup {
 const Arrow({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class Beam implements ColorGroup, OptionalUniqueIdGroup {
 const Beam({
    required this.value,
    required this.number,
...
class Bend implements PrintStyleGroup, BendSoundGroup {
 const Bend({
    required this.shape,
    required this.defaultX,
    required this.defaultY,
...
class BreathMark implements PrintStyleGroup, PlacementGroup {
 const BreathMark({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class Caesura implements PrintStyleGroup, PlacementGroup {
 const Caesura({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class Elision implements FontGroup, ColorGroup {
 const Elision({
    required this.value,
    required this.smufl,
    required this.fontFamily,
...
class EmptyLine implements LineShapeGroup, LineTypeGroup, LineLengthGroup, DashedFormattingGroup, PrintStyleGroup, PlacementGroup {
 const EmptyLine({
...
class Extend implements PositionGroup, ColorGroup {
 const Extend({
    required this.type,
    required this.defaultX,
    required this.defaultY,
...
class FiguredBass implements PrintStyleAlignGroup, PlacementGroup, PrintoutGroup, OptionalUniqueIdGroup {
 const FiguredBass({
    required this.parentheses,
    required this.defaultX,
    required this.defaultY,
...
class Glissando implements LineTypeGroup, DashedFormattingGroup, PrintStyleGroup, OptionalUniqueIdGroup {
 const Glissando({
    required this.value,
    required this.type,
    required this.number,
...
class HammerOnPullOff implements PrintStyleGroup, PlacementGroup {
...
class Handbell implements PrintStyleGroup, PlacementGroup {
 const Handbell({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class HarmonMute implements PrintStyleGroup, PlacementGroup {
 const HarmonMute({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class Harmonic implements PrintObjectGroup, PrintStyleGroup, PlacementGroup {
 const Harmonic({
    required this.printObject,
    required this.defaultX,
    required this.defaultY,
...
class Hole implements PrintStyleGroup, PlacementGroup {
 const Hole({
    required this.defaultX,
    required this.defaultY,
    required this.relativeX,
...
class Lyric implements JustifyGroup, PositionGroup, PlacementGroup, ColorGroup, PrintObjectGroup, OptionalUniqueIdGroup {
 const Lyric({
    required this.number,
    required this.name,
    required this.timeOnly,
...
class NonArpeggiate implements PositionGroup, PlacementGroup, ColorGroup, OptionalUniqueIdGroup {
 const NonArpeggiate({
    required this.type,
    required this.number,
    required this.defaultX,
...
class Notations implements PrintObjectGroup, OptionalUniqueIdGroup {
 const Notations({
    required this.printObject,
    required this.id,
  });
...
class Note implements XPositionGroup, FontGroup, ColorGroup, PrintoutGroup, OptionalUniqueIdGroup {
 const Note({
...
class Notehead implements FontGroup, ColorGroup, SmuflGroup {
 const Notehead({
    required this.value,
...
class Ornaments implements OptionalUniqueIdGroup {
 const Ornaments({
    required this.id,
  });
...
class OtherNotation implements PrintObjectGroup, PrintStyleGroup, PlacementGroup, SmuflGroup, OptionalUniqueIdGroup {
 const OtherNotation({
    required this.value,
    required this.type,
    required this.number,
...
class OtherPlacementText implements PrintStyleGroup, PlacementGroup, SmuflGroup {
...
class OtherText implements SmuflGroup {
 const OtherText({
    required this.value,
    required this.smufl,
  });
...
class PlacementText implements PrintStyleGroup, PlacementGroup {
 const PlacementText({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class Slide implements LineTypeGroup, DashedFormattingGroup, PrintStyleGroup, BendSoundGroup, OptionalUniqueIdGroup {
 const Slide({
    required this.value,
    required this.type,
    required this.number,
...
class Slur implements LineTypeGroup, DashedFormattingGroup, PositionGroup, PlacementGroup, OrientationGroup, BezierGroup, ColorGroup, OptionalUniqueIdGroup {
 const Slur({
    required this.type,
    required this.number,
    required this.lineType,
...
class Stem implements YPositionGroup, ColorGroup {
 const Stem({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class StyleText implements PrintStyleGroup {
 const StyleText({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class Tap implements PrintStyleGroup, PlacementGroup {
 const Tap({
    required this.value,
    required this.hand,
    required this.defaultX,
...
class Technical implements OptionalUniqueIdGroup {
 const Technical({
    required this.id,
  });
...
class TextElementData implements FontGroup, ColorGroup, TextDecorationGroup, TextRotationGroup, LetterSpacingGroup, TextDirectionGroup {
...
class Tied implements LineTypeGroup, DashedFormattingGroup, PositionGroup, PlacementGroup, OrientationGroup, BezierGroup, ColorGroup, OptionalUniqueIdGroup {
 const Tied({
    required this.type,
    required this.number,
    required this.lineType,
...
class Tremolo implements PrintStyleGroup, PlacementGroup, SmuflGroup {
 const Tremolo({
    required this.value,
    required this.type,
    required this.defaultX,
...
class Tuplet implements LineShapeGroup, PositionGroup, PlacementGroup, OptionalUniqueIdGroup {
 const Tuplet({
    required this.type,
    required this.number,
    required this.bracket,
...
class TupletDot implements FontGroup, ColorGroup {
 const TupletDot({
    required this.fontFamily,
    required this.fontStyle,
    required this.fontSize,
...
class TupletNumber implements FontGroup, ColorGroup {
 const TupletNumber({
    required this.value,
    required this.fontFamily,
    required this.fontStyle,
...
class TupletType implements FontGroup, ColorGroup {
 const TupletType({
    required this.value,
    required this.fontFamily,
    required this.fontStyle,
...
/// 
class Credit implements OptionalUniqueIdGroup {
 const Credit({
    required this.page,
    required this.id,
  });
...
class EmptyFont implements FontGroup {
 const EmptyFont({
    required this.fontFamily,
    required this.fontStyle,
    required this.fontSize,
...
class GroupBarline implements ColorGroup {
 const GroupBarline({
    required this.value,
    required this.color,
  });
...
class GroupName implements GroupNameTextGroup {
 const GroupName({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class GroupSymbol implements PositionGroup, ColorGroup {
 const GroupSymbol({
    required this.value,
    required this.defaultX,
    required this.defaultY,
...
class LyricFont implements FontGroup {
 const LyricFont({
    required this.number,
    required this.name,
    required this.fontFamily,
...
class Opus implements LinkAttributesGroup {
 const Opus({
    required this.href,
    required this.type,
    required this.role,
...
class PartLink implements LinkAttributesGroup {
 const PartLink({
    required this.href,
    required this.type,
    required this.role,
...
class PartName implements PartNameTextGroup {
 const PartName({
    required this.value,
    required this.defaultX,
    required this.defaultY,
